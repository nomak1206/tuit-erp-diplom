...
export default function Settings() {
    ...
    const tabItems = [
                ...
                <Card bordered={false}>
                    ...
                    <Form form={profileForm} layout="vertical" onFinish={handleProfileSave} initialValues={{ full_name: user?.full_name || t('layout.admin'), email: user?.email || 'admin@erp.uz', phone: '+998 90 123 45 67', language: i18n.language }}>
                        <Row gutter={16}>
                            ...
                            <Col span={12}><Form.Item name="language" label={t('settings.language')}><Select onChange={handleLanguageChange} options={[{ value: 'ru', label: 'Русский' }, { value: 'uz', label: "O'zbekcha" }]} /></Form.Item></Col>
                        </Row>
        ...
        },
        {
            ...
            children: (
                <Card bordered={false}>
                    <Form form={systemForm} layout="vertical" onFinish={handleSave(t('settings.system_tab'))} initialValues={{ company_name: 'ООО "ERP Solutions"', currency: 'UZS', timezone: 'Asia/Tashkent', fiscal_year: 1, auto_backup: true, org_inn: '302456789', org_legal_address: 'г. Ташкент, Яккасарайский р-н, ул. Шота Руставели 12', org_director: 'Каримов А.Ш.', org_oked: '62010', fiscal_year_end: 12 }}>
                        ...
                        <Row gutter={16}>
                            <Col span={12}><Form.Item name="currency" label={t('settings.currency')}><Select options={[{ value: 'UZS', label: 'UZS (Сум)' }, { value: 'USD', label: 'USD (Доллар)' }, { value: 'EUR', label: 'EUR (Евро)' }]} /></Form.Item></Col>
                            <Col span={12}><Form.Item name="timezone" label={t('settings.timezone')}><Select options={[{ value: 'Asia/Tashkent', label: 'UTC+5 (Tashkent)' }, { value: 'Europe/Moscow', label: 'UTC+3 (Moscow)' }]} /></Form.Item></Col>
